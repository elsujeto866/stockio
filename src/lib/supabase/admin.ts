 ...
 *
 * The secret key passed to this client BYPASSES Row Level Security entirely.
 * If this key reaches the browser, any user can read and write every row in
 * the database across all tenants.
 *
 ...
 * that no file outside this one references SUPABASE_SECRET_KEY.
 *
